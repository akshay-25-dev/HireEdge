...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        // Previously nothing stopped an empty submission from reaching the
        // backend (which, until the backend fix, would crash on a missing
        // resume file). The UI already promises "resume OR self description"
        // - now it actually enforces that before making a request.
        if (!jobDescription.trim()) {
            setFormError("Please add the target job description.")
            return
        }
        if (!resumeFile && !selfDescription.trim()) {
            setFormError("Please upload a resume or add a quick self description.")
            return
        }
        setFormError(null)
    ...
    if (loading) {
        return <Loader label="Generating your interview plan..." />
    }
            ...
            <div className='interview-card'>
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--left'>
                        ...
                        />
                        <div className='char-counter'>{jobDescription.length} / {JOB_DESCRIPTION_MAX} chars</div>
                    </div>
